<div align="center">
  ...
  <h3>AI Engineer | Computer Vision & Edge AI Specialist</h3>
  
  <p>Building production-ready AI + IoT solutions that solve real-world problems.</p>
...
![OpenCV](https://img.shields.io/badge/OpenCV-5C5C5C?style=flat&logo=opencv&logoColor=white)
![YOLOv8](https://img.shields.io/badge/YOLOv8-00FF00?style=flat&logo=ultralytics&logoColor=black)
...
Built a real-time smart waste segregation system using Computer Vision and Edge AI. Fine-tuned YOLOv8 & MobileNetV2 models for deployment on Raspberry Pi and NVIDIA Jetson Orin Nano.

**XAM.AI – AI Powered Study Buddy**  
End-to-end AI learning assistant with personalized recommendations, progress tracking, and explainable AI features. Built with FastAPI + React.

**Decision-Driven Customer Retention System**  
Developed a production-ready ML microservice for customer churn prediction and retention analysis using FastAPI, Scikit-learn, and Pandas.
